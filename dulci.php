...
<form action='dulci.php' action='get'>
...
<?php
 ...
 $query=mysqli_query($conn,"select * from produse where produs_categorie='dulci' ");
 ...
 while($row = mysqli_fetch_assoc($query)){
		...
		echo "<br> <form
		  action='dulci.php?produs_id=".$row['produs_id']."' method='post'>
